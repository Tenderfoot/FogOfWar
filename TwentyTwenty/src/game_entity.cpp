...
void GameEntity::draw() 
{
	if (visible)
	{
		...
		PaintBrush::transform_model_matrix(PaintBrush::get_shader("spine"), glm::vec3(draw_position.x + draw_offset.x, -draw_position.y - draw_offset.y, 0.0f), rotation, scale);
